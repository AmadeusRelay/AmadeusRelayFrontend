...
<div id="token-pairs-section">
      <div class="container">
        <div class="row">
            <div class="col-md-12">
              <p>You can interact with Amadeus Relay using our <a target="_blank" href="http://api.amadeusrelay.org/api-docs/">Rest API</a> or the <a target="_blank" href="https://0xproject.com/docs/connect">0xConnect</a> library.</p>
          </div>
        </div>
        <div class="row">
            <div class="col-md-12">
